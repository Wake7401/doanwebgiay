    ...
    <div class="page-header">
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                ...
                <span class="breadcrumb-item active">Chỉnh sửa chi tiết</span>
            </nav>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
            <form method="POST" action="admin/product/{{$product-> id}}/detail/{{$productDetail -> id}}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="size" name="size" value="{{$productDetail -> size}}">
                </div>
                <div class="mb-3">
                    <label for="username" class="form-label">Số lượng</label>
                    <input type="text" class="form-control" id="qty" name="qty" value="{{$productDetail -> qty}}">
                </div>
